...
input int            TwoMinDistance                          = 130;      // 第二最小距离
...
void BuildPanelMetrics(PanelMetrics &m)
  {
   const long chart_width=ChartGetInteger(0,CHART_WIDTH_IN_PIXELS,0);
   const int available_w=(int)MathMax(340.0,(double)chart_width - ScalePx(24));

   m.margin_x       = ScalePx(14);
   m.margin_y       = ScalePx(14);
   m.width          = (int)MathMax(340.0,MathMin((double)ScalePx(580),(double)available_w));
   m.pad            = ScalePx(14);
   ...
   m.card_status_h  = ScalePx(112);
   m.card_metrics_h = ScalePx(122);
   m.card_actions_h = ScalePx(168);
...
void DrawPanel(const EAStats &stats)
  {
   ...
   EnsureLabel(g_panel_prefix + "title","多米诺量化",title_x,y0 + ScalePx(11),ScaleFont(23),C'165,220,255',corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "title_tf","M3",title_x + ScalePx(166),y0 + ScalePx(11),ScaleFont(24),blue,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "min_icon","—",panel_right - ScalePx(94),y0 + ScalePx(12),ScaleFont(20),muted,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "close_icon","×",panel_right - ScalePx(50),y0 + ScalePx(11),ScaleFont(24),muted,corner,"Microsoft YaHei UI");
   ...
   EnsureLabel(g_panel_prefix + "status_circle","○",inner_x + ScalePx(20),y + ScalePx(41),ScaleFont(40),green,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "status_check","✓",inner_x + ScalePx(37),y + ScalePx(55),ScaleFont(26),green,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "status_main",status_main,inner_x + ScalePx(92),y + ScalePx(45),ScaleFont(22),trading_allowed ? green : gold,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "status_sub",status_sub,inner_x + ScalePx(94),y + ScalePx(80),m.font_sm,soft,corner);
   EnsureRectangle(g_panel_prefix + "status_divider",inner_x + inner_w / 2 + ScalePx(10),y + ScalePx(22),ScalePx(1),m.card_status_h - ScalePx(44),C'72,84,100',C'72,84,100',corner);
   EnsureLabel(g_panel_prefix + "symbol_title","交易品种",inner_x + inner_w / 2 + ScalePx(52),y + ScalePx(16),m.font_md,muted,corner);
   EnsureLabel(g_panel_prefix + "symbol",symbol_text,inner_x + inner_w / 2 + ScalePx(52),y + ScalePx(47),ScaleFont(22),gold,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "symbol_desc",symbol_desc,inner_x + inner_w / 2 + ScalePx(52),y + ScalePx(80),m.font_sm,soft,corner);
   ...
   EnsureLabel(g_panel_prefix + "metric_1_t","今日进度",inner_x + ScalePx(44),card_y + ScalePx(17),m.font_sm,soft,corner);
   EnsureLabel(g_panel_prefix + "metric_1_v",FormatSignedMoney(today_progress) + " " + currency,inner_x + ScalePx(22),card_y + ScalePx(43),ScaleFont(17),today_progress >= 0.0 ? green : red,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "metric_1_s",daily_equity_text,inner_x + ScalePx(30),card_y + ScalePx(76),m.font_sm,daily_equity_loss ? red : green,corner);
   ...
   EnsureLabel(g_panel_prefix + "metric_2_t","今日已平",card2_x + ScalePx(44),card_y + ScalePx(17),m.font_sm,soft,corner);
   EnsureLabel(g_panel_prefix + "metric_2_v",FormatSignedMoney(today_profit) + " " + currency,card2_x + ScalePx(22),card_y + ScalePx(43),ScaleFont(17),blue,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "metric_2_s","已平仓 " + IntegerToString(closed_count) + " 笔",card2_x + ScalePx(36),card_y + ScalePx(76),m.font_sm,soft,corner);
   ...
   EnsureLabel(g_panel_prefix + "metric_3_t","账户余额",card3_x + ScalePx(44),card_y + ScalePx(17),m.font_sm,soft,corner);
   EnsureLabel(g_panel_prefix + "metric_3_v",DoubleToString(balance,2) + " " + currency,card3_x + ScalePx(18),card_y + ScalePx(43),ScaleFont(16),gold,corner,"Microsoft YaHei UI");
   EnsureLabel(g_panel_prefix + "metric_3_s","净值 " + DoubleToString(equity,2),card3_x + ScalePx(22),card_y + ScalePx(76),m.font_sm,soft,corner);
   ...
   EnsureLabel(g_panel_prefix + "display_green_sub",trade_line,inner_x + ScalePx(118),strip_y + m.button_h + ScalePx(8),m.font_sm,muted,corner);
   ...
   EnsureLabel(g_panel_prefix + "display_red_sub","平掉本账号所有EA订单（含多单、空单）",inner_x + ScalePx(116),strip_y + m.button_h + ScalePx(8),m.font_sm,muted,corner);
